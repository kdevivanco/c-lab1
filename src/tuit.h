...
//    Tuit() = default;
    ...
    Tuit(Tuit&& other);//noexcept error
    //Copy assignment
    Tuit& operator=(const Tuit& other);
    //Move assignment
    //Tuit& operator=(Tuit&& other);//noexcept error
...
//     Media() = default;
//     Media(int id,string file_name);
//     virtual ~Media() = default;
//     private: 
//         string file_name;

// //Se debe incluir el constructor de la clase padre. Hereda "obligaciones"
